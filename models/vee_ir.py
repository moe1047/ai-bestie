...
class UnifiedGoal(BaseModel):
    ...
    clarification_needed: bool = Field(
        description="Whether the user needs to provide more information."
    )
...
class Plan(BaseModel):
    ...
    tasks: List[Dict[str, Any]] = Field(
        description="A list of tasks for the generator."
    )
    clarification_needed: bool = Field(
        description="Whether clarification is still needed."
    )
